        ...
        <div class=" items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        <a href="{{ url('/admin') }}" class="btn btn-info text-white">Admin</a>
                    @else
            ...
            <!-- <div class="container mb-5">
                ...
                <form method="GET" action="/filter">
                    ...
                    <input type="text" name="price_range" id="price_range" placeholder="10-100">
            ...
            <div class="col-lg-7 col-md-7 col-sm-7 col-6">
                                        <div class="product-sorting mb-5 mx-5">
                                            <p>Sort By :</p>
                                            <form method="GET" action="/filter">
            ...
            <div class="container">
                ...
                @foreach($products as $product)
                  <div class="card mr-2" style="width: 18rem;">
                    <img src="{{ asset('storage/products/'.$product->thumbnail) }}" class="card-img-top mt-2" alt="..."style="height:200px;">
                    <div class="card-body">
